...
namespace TestForFlightManagmentProject
{
    ...
    public class TestForWebApiControllers : TestCenter
    {
        ...
        {
            User user = new User(FlyingCenterConfig.ADMIN_NAME, FlyingCenterConfig.ADMIN_PASSWORD, UserType.Administrator, true);
        ...
        public void TestForCompaniesController()
        {
            ...
            string companyToken = GetTokenAsync(new User(company.User_Name, company.Password, UserType.Airline, true));
